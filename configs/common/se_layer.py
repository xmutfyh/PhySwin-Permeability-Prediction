...
class SELayer(nn.Module):
    """Squeeze-and-Excitation Module for regression tasks.

    Args:
        channels (int): The input (and output) channels of the SE layer.
        squeeze_channels (None or int): The intermediate channel number of
            SE layer. Default: None, means the value of ``squeeze_channels``
        ...
        act_cfg (dict or Sequence[dict]): Config dict for activation layer.
            ...
            Default: (dict(type='ReLU'), dict(type='Linear'))
    """
    ...
    def __init__(self,
                 ...
                 divisor=8,
                 conv_cfg=None,
                 act_cfg=(dict(type='ReLU'), dict(type='Linear'))):
