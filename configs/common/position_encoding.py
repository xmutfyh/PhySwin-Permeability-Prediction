...
class ConditionalPositionEncoding(BaseModule):
    ...
    def __init__(self, in_channels, embed_dims=256, stride=1, init_cfg=None):
        ...
        self.proj = nn.Conv2d(
            ...
            padding=1,
            bias=True,
            groups=1)  # Assuming no groups for this purpose
        self.stride = stride
...
class PositionEncodingFourier(BaseModule):
    ...
    Args:
        in_channels (int): Number of input channels. Default: 32.
        embed_dims (int): The feature dimension. Default: 768.
        temperature (int): Temperature for scaling. Default: 10000.
        dtype (torch.dtype): The data type. Default: torch.float32.
        init_cfg (dict): Initialization config for the module. Default: None.
    """
