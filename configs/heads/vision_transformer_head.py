...
class VisionTransformerRegHead(RegHead):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(VisionTransformerRegHead, self).__init__(init_cfg=init_cfg, *args, **kwargs)
    ...
    def _init_layers(self):
        if self.hidden_dim is None:
            layers = [('head', nn.Linear(self.in_channels, 1))]
        else:
            layers = [
    ...
    def init_weights(self):
        super(VisionTransformerRegHead, self).init_weights()
